...
out_dir = "tweetqa-robertaB-ti3-eb3-noyearevent"
...
def probe_info(text):
    # answers = qna_pipeline(question=["How many are dead?", "How many are injured?", "Where?", "What year?", "What disaster?"], context=text)
    ...
    #    return None
    # elif ("quake" in answers[4]["answer"]) or ("Quake" in answers[4]["answer"]):
    #     return info
    # else:
    #     return None
