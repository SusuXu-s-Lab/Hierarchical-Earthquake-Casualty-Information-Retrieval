...
class DisasterNLP(object):
    def __init__(self, country_name, month, day, pretrain_token, pretrain_type, pretrain_event, pretrain_parsing):
        self.out_dir = country_name + str(month) + '_' + str(day) + 'tweets'
...
def main():
    ...
    parser.add_argument("--news_data_dir", type=str, default="us_tweets_philippines_14160728_filipino.csv", help="data file name")
    ...
    filtered_t = {"time":[],"text":[], "lang":[]}
    death_t = {"time":[], "text":[], "lang":[], "deaths":[], "death_score":[], "injuries":[], "injury_score":[], "city":[], "city_score":[], "country":[], "country_score":[], "earthquake":[], "earthquake_score":[], "tweet_loc":[]}
    injury_t = {"time":[], "text":[], "lang":[], "deaths":[], "death_score":[], "injuries":[], "injury_score":[], "city":[], "city_score":[], "country":[], "country_score":[], "earthquake":[], "earthquake_score":[], "tweet_loc":[]}
    print("*"*50)
    for i, tweet in df.iterrows():
        ...
        if info is None:
            ...
            filtered_t["lang"].append(tweet["lang"])
            ...
            if info["deaths"][0] != -1:
                ...
                death_t["lang"].append(tweet["lang"])
            ...
            if info["injuries"][0] != -1:
                ...
                injury_t["lang"].append(tweet["lang"])
    ...
    print(death_t)
    print(injury_t)
    shutil.copy(__file__, "output/%s/process_tweets_gpt.py" % model.out_dir)
